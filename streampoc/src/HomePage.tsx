    ...
    <div className="landing">
      ...
      <header className="landing-nav">
        <div className="brand">
          ...
          <div>
            ...
            <span className="hidden sm:block">Go live in seconds</span>
          </div>
        </div>
      ...
      <main className="landing-hero">
        <div className="hero-content text-center sm:text-left">
          ...
          <h1 className="text-[28px] sm:text-[34px] lg:text-[40px] leading-tight">
            Stream to your audience with a console built for creators.
          </h1>
          <p className="hero-lead mx-auto sm:mx-0">
            Manage your camera, mic, and live reactions from one clean dashboard.
            Jump in, go live, and connect with your community.
          </p>
          <div className="hero-actions items-center sm:items-start">
            <button type="button" className="hero-login w-full sm:w-auto" onClick={onLoginClick}>
        ...
        <div className="hero-visual w-full max-w-[320px] sm:max-w-95 mx-auto" aria-hidden="true">
          <div className="hero-card max-w-full">
      ...
      <section className="live-section">
        ...
        {rooms.length === 0 && !loading ? (
          ...
          <div className="live-grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
            {rooms.map((room) => (
              <button
                key={room.name}
                type="button"
